...
public class PtpConstants {
    ...
    public static class Event {
        ...
        public static final int EosObjectAdded5D4 = 49575;
    ...
    public static class ObjectFormat {
        ...
        public static final int EosMOV = 45316;
            ...
            if (readLine != null) {
                if ("OperationsSupported:".equals(readLine)) {
                    ...
                    if (readLine.startsWith("    0x")) {
                        readLine = readLine.trim().substring(2);
                    } else {
                        readLine = readLine.substring(readLine.indexOf(40) + 3, readLine.length() - 1);
                    }
                    int parseInt = Integer.parseInt(readLine, 16);
                    String str = null;
                    switch (obj) {
                        case 1:
                            str = operationToString(parseInt);
                            break;
                        case 2:
                            str = eventToString(parseInt);
                            break;
                        case 3:
                            str = propertyToString(parseInt);
                            break;
                        case 4:
                        case 5:
                            str = objectFormatToString(parseInt);
                            break;
                    }
                    bufferedWriter.write(String.format("    %s", new Object[]{str}));
                } else {
                    bufferedWriter.write(readLine);
                }
